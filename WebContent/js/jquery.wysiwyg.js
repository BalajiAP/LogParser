...
(function( $ )
{
    ...
    $.fn.wysiwyg = function( options )
    {
        ...
        options = $.extend({
            html : '<'+'?xml version="1.0" encoding="UTF-8"?'+'><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head>STYLE_SHEET<meta charset="UTF-8"></head><body style="margin: 0px;">INITIAL_CONTENT</body></html>',
            css  : {},
